        ...
        <div className=" bg-gray-900 text-white flex justify-between items-center px-12 py-4">
            ...
            <ul className="flex">
                ...
                <div className="flex">
                    ...
                    <Link to="/offers" className="mx-6">Offers</Link>
                </div>
                <div className="flex">
                    <span className="mt-1"> <IoHelpBuoyOutline /> </span>
                    <Link to="/help" className="mx-6">Help</Link>
                </div>
                <div className="flex">
                    <span className="mt-1"> <CgProfile /> </span>
                    <Link to="/signin" className="mx-6">Signin</Link>
                </div>
                <div className="flex">
                    <span className="mt-1"> <IoCartOutline /> </span>
                    <Link to="/cart" className="mx-6">Cart-{cartItems.length}</Link>
                </div>
            </ul>
